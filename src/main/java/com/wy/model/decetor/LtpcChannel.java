...
public class LtpcChannel {
	...
	public LtpcChannel(int pid, int area, int board, int col, int row, double x_center, double y_center,
			int interfaceId, int channelId, int eleId, int slope) {
		super();
		this.pid = pid;
		this.area = area;
		this.board = board;
	...
	public String toString() {
		return "LtpcChannel [pid=" + pid + ", area=" + area + ", board=" + board + ", col=" + col + ", row=" + row
				+ ", x_center=" + x_center + ", y_center=" + y_center + ", interfaceId=" + interfaceId + ", channelId="
				+ channelId + ", heigh=" + heigh + ", wdith=" + wdith + ", slope=" + slope + ", eleId=" + eleId + "]";
	}
